...
we’ll be examining an important question: What is the relationship between subway ridership and wait times? Specifically, does higher ridership lead to longer wait times?

To answer this, we analyzed two key datasets from the MTA:
...
ggsave("avg_time_plot.png", plot = platform_time_plot, width = 10, height = 6, dpi = 300)
```
1. **Line Variability**:
