...
The *Washington State Ferries (Ferryboat)* system had the highest total fares per `VRM`, with **$937.00**. Ferries typically have high operating costs and therefore charge higher fares per mile traveled.
