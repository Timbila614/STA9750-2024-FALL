...
```{R Chloropleth graph 3, fig.heigth=10, fig.width=22}
#| message: false
#| warning: false
#| code-fold: true
...
```{R Animated Chloropleth graph 4, echo=TRUE, results = "hide", fig.heigth=10, fig.width=22}
#| message: FALSE
#| warning: FALSE
#| code-fold: true
...
animate(animate_election_results, width = 1000, height = 600, fps = 10)
