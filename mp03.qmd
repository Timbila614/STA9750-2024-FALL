...
```{R, echo=TRUE, results = "hide", fig.heigth=10, fig.width=22}
#| message: FALSE
#| warning: FALSE
#| code-fold: true
...
animate(
  animate_election_results,
  renderer = gifski_renderer(file = paste0(save_directory, "/election_results_animation2.gif")),
  width = 1000,
  height = 600,
  fps = 10)
